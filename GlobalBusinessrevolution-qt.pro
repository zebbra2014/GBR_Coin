TEMPLATE = app
TARGET = globalbusinessrevolution-qt
macx:TARGET = "GlobalBusinessrevolution-Qt"
VERSION = 0.8.7.5
...
QT += testlib
TARGET = globalbusinessrevolution-qt_test
...
macx:ICON = src/qt/res/icons/globalbusinessrevolution.icns
