...
#if defined(NDEBUG)
# error "GlobalBusinessrevolution cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xc8a00e3aaa7ad38aadc551a4bc9bebb3702361724c63de288f7875cc3278c161");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // GlobalBusinessrevolution: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "GlobalBusinessrevolution Signed Message:\n";
...
{
    // GlobalBusinessrevolution: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // GlobalBusinessrevolution: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // GlobalBusinessrevolution: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1470999607, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "The Times 12Aug2016 Chancellor on brink of second bailout for banks";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 200 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04718f1b36e5785381dc5f3521e07b5462ced956920daf1b52b6762fcaf371c9d06006e14bd0db93994be71ed3644e3f990d0853f4693dda06bebcf48530c62ce0") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1470999607;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1012456;
        ...
        assert(block.hashMerkleRoot == uint256("0x0893c2b92e836c5de88069b80efbb3fa51619181aeaba88ac7d672b6ac1199c8"));
...
unsigned char pchMessageStart[4] = { 0x5b, 0x80, 0x57, 0xc2 }; // GlobalBusinessrevolution: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("GlobalBusinessrevolutionMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GlobalBusinessrevolutionMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GlobalBusinessrevolutionMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static GlobalBusinessrevolutionMiner(CWallet *pwallet)
{
    printf("GlobalBusinessrevolutionMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("globalbusinessrevolution-miner");
    ...
    try { loop {
        ...
        printf("Running GlobalBusinessrevolutionMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GlobalBusinessrevolutionMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&GlobalBusinessrevolutionMiner, pwallet));
}
